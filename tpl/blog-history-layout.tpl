...
<html lang="en">
  <head>
    ...
    <meta name="description" content="{%$page.seo_desc|default:'goosman-lei的博客'%}">
    <meta name="keywords" content="{%$page.seo_keywords|default:'PHP Web开发,PHP,PHP 框架,高可用,分布式'%}">

    <title>{%$page.seo_title|default:'PHP Web开发框架'%}- By Goosman-lei(goosman.lei@gmail.com</title>
